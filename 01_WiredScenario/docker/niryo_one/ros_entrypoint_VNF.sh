...
if [ $# -eq 1 ]; then
	...
	if [ $1 = "help" ] ; then
		...
		sleep $2
		source /root/catkin_ws/devel/setup.bash
		python -u /subscriber_DL.py > /Output_script/output_subscriber_DL_$3_robots$4_$5.txt &
		python -u /publisher_UL.py > /Output_script/output_publisher_UL_$3_robots$4_$5.txt &
		exec "bash"
		exit
	elif [ $1 = "control" ] ; then
		echo -e "\nCONTROL WILL BE EXECUTED\n"
		...
		sleep $2
		source /root/catkin_ws/devel/setup.bash
		python -u /subscriber_UL.py > /Output_script/output_subscriber_UL_$3_robots$4_$5.txt &
		python -u /publisher_DL.py > /Output_script/output_publisher_DL_$3_robots$4_$5.txt &
		exec "bash"
		exit
	elif [ $1 = "state" ] ; then
		echo -e "\nSTATE WILL BE EXECUTED\n"
