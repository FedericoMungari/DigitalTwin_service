...
function provafunct () {
	echo "VM_PSW: ",$1; echo "VM_USERNAME: ",$2; echo "DRIVER_VM_IP: ",$3; echo "CONTROLLER_VM_IP: ",$4; echo "STATE_VM_IP: ",$5; echo "MOTIONPLANNING_VM_IP: ",$6; echo "ROBOTCOMMANDER_VM_IP: ",$7; echo "INTERFACE_MASTER_VM_IP: ",$8
}
